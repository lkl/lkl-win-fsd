...
{
	if (n > RTL_NUMBER_OF(IrpMjStrings))
		return "IrpMjToString index out of bounds";
	return IrpMjStrings[n];	
}

PCHAR FileInformationClassToString(unsigned int n)
{
	if (n > RTL_NUMBER_OF(FileInformationClassStrings))
		return "FileInformationClassToString index out of bounds";
	return FileInformationClassStrings[n];
}

PCHAR FsInformationClassToString(unsigned int n)
{
	if (n > RTL_NUMBER_OF(FsInformationClassStrings))
		return "FsInformationClassToString index out of bounds";
	return FsInformationClassStrings[n];
}
